...
<body class="align" style="background-color: #343a40;">
	<div class="grid">
  		...
  		<div class="img-cls">
  			<img src="img/logo.png" class="img-logo" style="width: 50%;height: auto;margin-left: 25%" alt="PortfolioBox Logo" title="PortfolioBox">	
  		</div>
    
    	<form action="login.php" method="post" class="form login">
    		<h1 class="text-info" style="margin-left: 5%"><i class="fas fa-sign-in-alt"></i> Sign Me!</h1>
